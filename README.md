...
<!--
Yêu cầu Day 2 Week 1:
- Cập nhật README.md với: tên intern, mục tiêu học tập, 3 khái niệm Git/GitHub đã hiểu, workflow "task -> branch -> commit -> push -> PR -> review", và mục "Notes / Questions".
- Làm trên branch riêng, không commit trực tiếp lên main.
- Có tối thiểu 2 commit rõ nghĩa.
- Push branch lên remote và mở Pull Request.
- PR cần có: Summary, Changes, How to Review, Checklist.
