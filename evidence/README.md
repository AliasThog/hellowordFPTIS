...
- Database name: `w1d3-database-postgresql`
...
```sql
CREATE DATABASE w1d3-database-postgresql;
```

Kết nối vào database:

```sql
\c w1d3-database-postgresql
```
...
```bash
psql -U postgres -d w1d3-database-postgresql -f sql/schema.sql
psql -U postgres -d w1d3-database-postgresql -f sql/seed.sql
psql -U postgres -d w1d3-database-postgresql -f sql/queries.sql
```
